        ...
        public override void OnImportAsset(AssetImportContext ctx)
        {
            try
            {
                ...
                foreach (var kvp in outProperties)
                {
                    ...
                    // Change name of the positiont texture to match the lead gameobject
                    surface.name = Path.GetFileNameWithoutExtension(ctx.assetPath) + "_" + kvp.Key;
